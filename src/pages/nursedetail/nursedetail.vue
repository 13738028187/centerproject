        ...
        <div class="cu-form-group">
                    ...
                    <scroll-view scroll-x="true" style=" white-space: nowrap; display: flex;background:white">
                        <view style="display: inline-block">
                            ...
                            <image v-for="(item1,index1) in datasubs" :key="index1" :src="item" style="width:250rpx;height:200rpx;margin-left:10rpx;margin-bottom:10rpx;margin-top:10rpx"></image>
                        </view>
                    </scroll-view>
    ...
    onLoad(options){
        ...
        body:{nid:this.nid}
             ...
             this.nurse=res.rows[0]
                ...
                if(this.nurse.datasub){
                    this.datasub=JSON.parse(this.nurse.datasub)
